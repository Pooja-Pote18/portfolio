...
Generates ATS Score by matching resumes with job descriptions.

🔹 AI Healthcare & Fitness Advisor

BMI-based health advisory system using user inputs.
Provides personalized diet and workout recommendations.
